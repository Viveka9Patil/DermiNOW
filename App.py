...
if page == "Home":    
    ...
    password = st.text_input("OTP", type="password")
    # password = st.text_input("OTP", type="password")

    user_type = st.selectbox("Select User Type", user_types)
    
    if st.button("Login"):
        if user_type == "Patient" and username in patient_credentials:
            st.success("Logged in as a Patient: " + username)
            st.session_state.logged_in = True
            st.session_state.user_type = "Patient"
        if user_type == "Doctor" and username in doctor_credentials:
    ...
    if st.session_state.user_type == "Patient":
        ...
        # About Us content
            ...
            **Our Team**
            ...
            if uploaded_image is not None:
                st.image(uploaded_image, caption="Uploaded Image", use_column_width=True)
                st.write("Diagnosed disease: " + "Eczema")
